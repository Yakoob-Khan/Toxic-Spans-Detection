...
def toxic_character_offsets(post_num, tokens, offset_mapping, prediction, val_sentences_info):
  ...
  # print(tokens)
  # print('-------')
  # for sen_num in post_num_to_sentence_nums:
  #   print(sen_num, sentence_num_to_label_pred[sen_num])
  #   print(sentence_num_to_spans[sen_num])
  ...
  for i, (token, offset, pred_label) in enumerate(zip(tokens, offset_mapping, prediction)):
    ...
    if pred_label == 1:
      ...
      for sen_num in post_num_to_sentence_nums:
        # get the span of this sentence in the respective post 
        a, d = sentence_num_to_spans[sen_num]
      ...
      if sentence_num_to_label_pred[sen_num] == 1:
